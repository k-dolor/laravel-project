...
<div class="container-fluid p-0" style= "margin-left: 80px; padding-top: 20px;">
    <div class="card" style="position: relative; margin-top: 20px;margin-right: 20px; background-color: rgba(5, 15, 15, 0.5); color: #fff">
        ...
        <p class="card-text" style="font-family: 'Bell MT'; font-size: 28px; "> "Are you sure you want to delete this role named" {{
            $role->role }}"?</p>
            <!---->
            <form action="/role/destroy/{{$role->role_id}}" method = "post">
                @method('DELETE')
            @csrf
            <div class="card-body">
                <div class="row h-100">
            <div class="mt-3">
                <a href="/roles" class="btn btn-primary ">NO</a>
