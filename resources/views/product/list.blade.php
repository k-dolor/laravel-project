...
<div class="container-fluid p-0" style="margin-left: 75px; margin-right: 5px; padding-top: 20px;">
    <!-- FORM for SEARCHHHHH -->
    <form action="#" method="GET" class="mb-2 mt-3" style="padding: 1rem;">
        <div class="input-group">
            <input type="text" class="form-control" placeholder="Search users..." name="query" style="background-color: rgba(232, 251, 255, 0.7);">
    ...
    <div class="card mt-2" style="background-color: rgba(213, 211, 211, 0.99); font-family: 'Metropolis';color: #000000">
        ...
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: rgba(64, 64, 64, 0.65); border-bottom: none;">
            {{-- <div class="card-header d-flex justify-content-between align-items-center" style="background-color: rgba(124, 114, 107, 0.65); border-bottom: none;"> --}}
