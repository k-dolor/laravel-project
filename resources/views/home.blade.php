...
{{-- <div class="row">
    ...
    <div class="card p-4 bg-transparent border-0">
        <h1 class="text-center main-heading" style="font-family: 'Bell MT', sans-serif; color: #ffffff;">Welcome to Album Station!</h1>

        <h3 class="text-center sub-heading" style="font-family: 'Bell MT', sans-serif; color: #ffffff;">
            Your destination for discovering, exploring, and collecting your favorite albums.
        </h3>
    </div>
</div>
