...
<div class="container-fluid p-0" style="margin-left: 75px; margin-top: 10px; margin-right: 5px; padding-top: 20px;">
    ...
    <div class="card mb-3" style="background-color: rgba(229, 225, 225, 0.8); color: #fff">
        <!-- Separate card for the title "List of Genders" -->
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: rgba(243, 243, 243, 0.6); border-bottom: none;">
            <h5 class="card-title" style="font-family: 'Bell MT'; font-size: 40px; color: #0b0b0b; margin-bottom: 0; margin-top: 10px;">List of Genders</h5>
            <a href="{{ url('/gender/create') }}" class="btn btn-outline-light btn-sm py-1 py-md-2 px-2 px-md-3" style="color: rgb(48, 32, 32); font-size: 14px;">
                <span class="d-none d-sm-inline">Add Gender</span>
        ...
        <div class="table-responsive mt-3">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-4">{{ $gender->gender }}</td>
                        <td class="py-4">{{ $gender->created_at }}</td>
                        <td class="py-4">{{ $gender->updated_at }}</td>
                        <td class="py-2">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="/gender/show/{{ $gender->gender_id }}" class="btn btn-show">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                        <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z"/>
                                        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
                                    </svg>
                                </a>
                                <a href="/gender/edit/{{ $gender->gender_id }}" class="btn btn-edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                    </svg>
                                </a>
                                <a href="/gender/delete/{{ $gender->gender_id }}" class="btn btn-del">
